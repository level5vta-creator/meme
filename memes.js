...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function closeMobileMenu(e) {
        if (e && e.cancelable) {
            e.preventDefault();
        } // prevent default but allow propagation if needed, though usually better to stop if handling it.
    ...
    if (mobileMenuBtn) {
        ...
        mobileMenuBtn.addEventListener('touchstart', openMobileMenu, { passive: false });
    }
    ...
    if (mobileMenuOverlay) {
        ...
        // Handle touch on overlay background
    ...
    mobileNavLinks.forEach(link => {
        ...
        // For links, we usually want the default action (navigation) to happen, 
        // so we don't preventDefault on touchstart, but we can close the menu.
        link.addEventListener('touchstart', () => {
            // Close menu but allow default link behavior
